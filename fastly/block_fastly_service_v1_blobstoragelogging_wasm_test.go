...
func TestResourceFastlyFlattenBlobStorageWASM(t *testing.T) {
	cases := []struct {
...
func TestAccFastlyServiceV1_blobstoragelogging_wasm_basic(t *testing.T) {
